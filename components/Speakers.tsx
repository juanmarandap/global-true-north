...
const SPEAKERS: Speaker[] = [
  ...
  { name: "Pablo Breuer",           category: "Ciberseguridad",             photo: "/images/speakers/pablo-breuer.jpg",      objectPosition: "center top", scale: 1.1,      bio: "Experto en ciberseguridad y seguridad nacional con amplia experiencia en el sector de defensa de EE.UU. Ayuda a organizaciones a comprender y gestionar las amenazas cibernéticas modernas.",                                                                                                                                     bioEn: "Cybersecurity and national security expert with extensive experience in the U.S. defense sector. He helps organizations understand and manage modern cyber threats." },

  // — Economía —
  { name: "Amin Toufani",           category: "Economía",                   photo: "/images/speakers/amin-toufani.jpg",      objectPosition: "center top", scale: 1.1,      bio: "Economista y futurista que analiza cómo las tecnologías exponenciales transforman los mercados globales. Faculty en Singularity University, ayuda a líderes a anticipar y capitalizar las disrupciones económicas.",                                                                                                                             bioEn: "Economist and futurist who analyzes how exponential technologies transform global markets. Faculty at Singularity University, he helps leaders anticipate and capitalize on economic disruptions." },
  ...
  { name: "Adriana Marais",         category: "Economía",                   photo: "/images/speakers/adriana-marais.jpg",    objectPosition: "center 15%", scale: 1.12,    bio: "Física teórica y experta en innovación que explora el futuro de la humanidad más allá de la Tierra. Lidera iniciativas en tecnología, ciencia y exploración espacial para construir un futuro sostenible.",                                                                                                                          bioEn: "Theoretical physicist and innovation expert who explores the future of humanity beyond Earth. She leads initiatives in technology, science and space exploration to build a sustainable future." },
  ...
  { name: "Denis Rivin",            category: "El Futuro del Aprendizaje",  photo: "/images/speakers/denis-rivin.jpg",       objectPosition: "center top",       bio: "Educador e innovador que transforma la manera en que las organizaciones aprenden y crecen. Desarrolla metodologías que combinan tecnología, creatividad y propósito para generar impacto real.",                                                                                                                                   bioEn: "Educator and innovator who transforms the way organizations learn and grow. He develops methodologies that combine technology, creativity and purpose to generate real impact." },
  { name: "Esther Wjocicki",        category: "El Futuro del Aprendizaje",  photo: "/images/speakers/esther-wjocicki.jpg",   objectPosition: "center 20%", scale: 1.1,   bio: "Pionera en educación progresiva conocida como la madrina de Silicon Valley. Mentora de innovadores y emprendedores globales, incluyendo cofundadores de Google y YouTube.",                                                                                                                                                   bioEn: "Pioneer in progressive education known as the godmother of Silicon Valley. Mentor of global innovators and entrepreneurs, including co-founders of Google and YouTube." },

  // — El Futuro del Trabajo —
  { name: "Taddy Blecher",          category: "El Futuro del Trabajo",      photo: "/images/speakers/taddy-blecher.jpg",     objectPosition: "center top", scale: 1.12,     bio: "Líder en educación que transforma vidas a gran escala. Ha impulsado iniciativas que convierten el acceso al aprendizaje en oportunidades reales de crecimiento y movilidad social.",                                                                                                                                             bioEn: "Education leader who transforms lives at scale. He has driven initiatives that turn access to learning into real opportunities for growth and social mobility." },
  ...
  { name: "Adriana Marais",         category: "Innovación Disruptiva",      photo: "/images/speakers/adriana-marais.jpg",    objectPosition: "center 15%", scale: 1.12,    bio: "Física teórica y experta en innovación que explora el futuro de la humanidad más allá de la Tierra. Lidera iniciativas en tecnología, ciencia y exploración espacial para construir un futuro sostenible.",                                                                                                                          bioEn: "Theoretical physicist and innovation expert who explores the future of humanity beyond Earth. She leads initiatives in technology, science and space exploration to build a sustainable future." },
  ...
  { name: "Andre Wegner",           category: "Manufactura Digital",        photo: "/images/speakers/andre-wegner.jpg",      objectPosition: "center top", scale: 1.1,      bio: "Experto en cómo la tecnología está redefiniendo la manufactura. Desde 3D printing hasta automatización inteligente, ayuda a empresas a reinventar cómo producen y operan.",                                                                                                                                     bioEn: "Expert in how technology is redefining manufacturing. From 3D printing to intelligent automation, he helps companies reinvent how they produce and operate." },
  { name: "Hod Lipson",             category: "Manufactura Digital",        photo: "/images/speakers/hod-lipson.jpg",        objectPosition: "center top", scale: 1.1,        bio: "Experto en robótica e inteligencia artificial que explora cómo las máquinas pueden aprender, adaptarse y crear. Profesor en Columbia University y referente global en el futuro de la interacción humano-máquina.",                                                                                                         bioEn: "Robotics and artificial intelligence expert who explores how machines can learn, adapt and create. Professor at Columbia University and global reference in the future of human-machine interaction." },
  { name: "Jason Dunn",             category: "Manufactura Digital",        photo: "/images/speakers/jason-dunn.jpg",        objectFit: "contain",                                                                                                                                                                                                                                                                                            bio: "Pionero en manufactura espacial y tecnologías disruptivas. Cofundador de Made In Space, la primera empresa en fabricar fuera de la Tierra, llevando la innovación más allá de los límites del planeta.",                                                                                                               bioEn: "Pioneer in space manufacturing and disruptive technologies. Co-founder of Made In Space, the first company to manufacture outside Earth, taking innovation beyond the limits of our planet." },
  { name: "Melba Kurman",           category: "Manufactura Digital",        photo: "/images/speakers/melba-kurman.jpg",      objectPosition: "center 20%", scale: 1.2,      bio: "Experta en tecnologías exponenciales que explica cómo innovaciones como el 3D printing y los vehículos autónomos están redefiniendo nuestra vida y el futuro.",                                                                                                                                                      bioEn: "Expert in exponential technologies who explains how innovations like 3D printing and autonomous vehicles are redefining our lives and the future." },
  ...
  { name: "Jaime Metzl",            category: "Salud y Medicina",           photo: "/images/speakers/jaime-metzl.jpg",       objectPosition: "center top",       bio: "Experto en el futuro de la humanidad que combina tecnología, genética y geopolítica. Asesora a organismos globales como la OMS sobre los cambios que están redefiniendo nuestro mundo.",                                                                                                                              bioEn: "Expert on the future of humanity who combines technology, genetics and geopolitics. He advises global organizations like the WHO on the changes redefining our world." },
  { name: "Kim Hullet",             category: "Salud y Medicina",           photo: "/images/speakers/kim-hullet.jpg",        objectPosition: "center 20%", scale: 1.15,        bio: "Experta en biotecnología que acerca el futuro de la salud a las personas. Desde genética hasta longevidad, explica cómo la tecnología está redefiniendo cómo vivimos y cuidamos nuestro cuerpo.",                                                                                                                   bioEn: "Biotechnology expert who brings the future of health closer to people. From genetics to longevity, she explains how technology is redefining how we live and care for our bodies." },

  // — Wellness —
  { name: "Lucila Padilla",         category: "Wellness",                   photo: "/images/speakers/lucila-padilla.png", objectPosition: "40% 15%", bio: "A lo largo de su trayectoria ha trabajado con empresas, universidades y organizaciones que buscan fortalecer la mentalidad, el bienestar y la capacidad de adaptación de sus equipos.",                                                                                                                          bioEn: "Throughout her career she has worked with companies, universities and organizations seeking to strengthen the mindset, well-being and adaptability of their teams." },
  { name: "Lucila Padilla",         category: "Innovación Disruptiva",      photo: "/images/speakers/lucila-padilla.png", objectPosition: "40% 15%", bio: "A lo largo de su trayectoria ha trabajado con empresas, universidades y organizaciones que buscan fortalecer la mentalidad, el bienestar y la capacidad de adaptación de sus equipos.",                                                                                                                          bioEn: "Throughout her career she has worked with companies, universities and organizations seeking to strengthen the mindset, well-being and adaptability of their teams." },
  { name: "Lucila Padilla",         category: "Mentalidad de Éxito",        photo: "/images/speakers/lucila-padilla.png", objectPosition: "40% 15%", bio: "A lo largo de su trayectoria ha trabajado con empresas, universidades y organizaciones que buscan fortalecer la mentalidad, el bienestar y la capacidad de adaptación de sus equipos.",                                                                                                                          bioEn: "Throughout her career she has worked with companies, universities and organizations seeking to strengthen the mindset, well-being and adaptability of their teams." },
  { name: "Lucila Padilla",         category: "El Futuro del Aprendizaje",  photo: "/images/speakers/lucila-padilla.png", objectPosition: "40% 15%", bio: "A lo largo de su trayectoria ha trabajado con empresas, universidades y organizaciones que buscan fortalecer la mentalidad, el bienestar y la capacidad de adaptación de sus equipos.",                                                                                                                          bioEn: "Throughout her career she has worked with companies, universities and organizations seeking to strengthen the mindset, well-being and adaptability of their teams." },
...
function SpeakerAvatar({ name, photo, color, objectPosition, objectFit = "cover", scale = 1 }: { name: string; photo: string; color: string; objectPosition?: string; objectFit?: "cover" | "contain"; scale?: number }) {
  ...
  return (
    <div
      ...
      style={{ boxShadow: `0 24px 64px ${color}35`, background: objectFit === "contain" ? `${color}15` : undefined }}
    >
      {!failed ? (
        <Image
          src={photo}
          ...
          style={{ objectPosition: objectPosition ?? "center 15%", transform: scale !== 1 ? `scale(${scale})` : undefined }}
          sizes="256px"
...
function SpeakerRow({ speaker, index }: { speaker: Speaker; index: number }) {
  ...
  const photoBlock = (
    ...
    >
      <SpeakerAvatar name={speaker.name} photo={speaker.photo} color={color} objectPosition={speaker.objectPosition} objectFit={speaker.objectFit} scale={speaker.scale} />
    </motion.div>
  );
