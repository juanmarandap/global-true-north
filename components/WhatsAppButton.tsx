...
export default function WhatsAppButton() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-[0_4px_24px_rgba(37,211,102,0.40)] hover:shadow-[0_6px_32px_rgba(37,211,102,0.55)] transition-shadow"
